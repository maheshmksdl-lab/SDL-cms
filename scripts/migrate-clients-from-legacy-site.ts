/**
 * Brings the real client logos across from the legacy site's /clients page.
 *
 ...
 * it on its own to a database that already has content. See src/seeds/legacyClients.ts.
 */
import 'dotenv/config'
import { getPayload } from 'payload'
import config from '../payload.config.js'

import { seedLegacyClients } from '../src/seeds/legacyClients'
